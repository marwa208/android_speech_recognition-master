...
//        Fourth: Open a browser and open url
        ...
        else if(result_message.indexOf("hi")!=-1 || result_message.indexOf("hello")!=-1 || result_message.indexOf("howdy")!=-1 ){
            speak("Hi there master. What's up");
        }
        else if(result_message.indexOf("how")!=-1){
            if(result_message.indexOf("you")!=-1 || result_message.indexOf("is it going")!=-1){
